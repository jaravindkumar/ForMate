...
.logo-dot{width:5px;height:5px;border-radius:50%;background:var(--p1);margin-left:.2rem;margin-bottom:.8rem;box-shadow:0 0 8px rgba(99,102,241,.8);}
...
.nbadge.live{background:rgba(239,68,68,.1);border-color:rgba(239,68,68,.25);color:#F87171;}
.nbadge.live::before{content:'';display:inline-block;width:5px;height:5px;border-radius:50%;background:#EF4444;margin-right:.4rem;animation:blink .9s infinite;}
...
.stTabs [aria-selected="true"]{background:linear-gradient(135deg,var(--p1),var(--v1))!important;color:#fff!important;box-shadow:0 4px 18px rgba(99,102,241,.3)!important;}
...
.zone::before{content:'';position:absolute;top:-80px;right:-80px;width:300px;height:300px;border-radius:50%;background:radial-gradient(circle,rgba(99,102,241,.06) 0%,transparent 70%);pointer-events:none;}
.live-zone::before{content:'';position:absolute;top:-80px;left:-80px;width:300px;height:300px;border-radius:50%;background:radial-gradient(circle,rgba(139,92,246,.06) 0%,transparent 70%);pointer-events:none;}
...
.live-headline span{color:#A78BFA;}
...
.card::before{content:'';position:absolute;inset:0;background:linear-gradient(135deg,rgba(99,102,241,.02) 0%,transparent 50%);pointer-events:none;}
...
.bfill.mid{background:linear-gradient(90deg,var(--amber),#FCD34D);}
...
.ci.pos{background:var(--green-bg);border:1px solid var(--green-bd);color:#6EE7B7;}
.ci.imp{background:var(--red-bg);border:1px solid var(--red-bd);color:#FCA5A5;}
.ci.foc{background:rgba(99,102,241,.07);border:1px solid rgba(99,102,241,.18);color:var(--p3);}
.ci-icon{font-size:.75rem;margin-top:.2rem;flex-shrink:0;opacity:.8;}

/* FLAGS */
.flag{display:flex;gap:.65rem;align-items:flex-start;padding:.7rem .95rem;border-radius:10px;background:var(--red-bg);border:1px solid var(--red-bd);font-size:.82rem;color:#FCA5A5;margin-bottom:.4rem;line-height:1.55;}
.fdot{width:5px;height:5px;border-radius:50%;background:var(--red);flex-shrink:0;margin-top:.45rem;}
...
/* FILE OK */
.fok{padding:.65rem 1rem;border-radius:10px;font-size:.8rem;background:rgba(99,102,241,.08);border:1px solid rgba(99,102,241,.2);color:var(--p2);display:flex;align-items:center;gap:.5rem;}
...
.status-badge.waiting{background:var(--amber-bg);border:1px solid var(--amber-bd);color:#FCD34D;}
.status-badge.detecting{background:rgba(99,102,241,.1);border:1px solid rgba(99,102,241,.25);color:var(--p2);}
.status-badge.recording{background:var(--red-bg);border:1px solid var(--red-bd);color:#F87171;}
.status-badge.done{background:var(--green-bg);border:1px solid var(--green-bd);color:#34D399;}
...
.empty-logo b{background:linear-gradient(135deg,rgba(99,102,241,.13),rgba(139,92,246,.2));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;}
...
function drawSkeleton(ctx,kp,flags,W,H){
  ...
  const cc=sts.includes("bad")?"#EF4444":sts.includes("warn")?"#F59E0B":"#3B82F6";
...
#status-badge.waiting{border-color:rgba(245,158,11,.5);color:#FCD34D;background:rgba(245,158,11,.08);}
#status-badge.active{border-color:rgba(59,130,246,.6);color:#60A5FA;background:rgba(59,130,246,.1);}
#status-badge.done{border-color:rgba(16,185,129,.5);color:#34D399;background:rgba(16,185,129,.08);}
...
.flag.ok  {background:rgba(16,185,129,.15);border:1px solid rgba(16,185,129,.3);color:#6EE7B7;}
.flag.warn{background:rgba(245,158,11,.15);border:1px solid rgba(245,158,11,.3);color:#FCD34D;}
.flag.bad {background:rgba(239,68,68,.18);border:1px solid rgba(239,68,68,.35);color:#FCA5A5;}
...
#btn-main.stop{background:rgba(239,68,68,.15);color:#F87171;border:1px solid rgba(239,68,68,.3);box-shadow:none;}
...
#btn-flip:active{border-color:rgba(59,130,246,.6);}
...
<div id="cam-container">
  <div id="cam-off">
    ...
    <div style="font-size:.95rem;font-weight:700;font-family:'Space Grotesk',sans-serif;letter-spacing:-.02em;"><span style="background:linear-gradient(135deg,#6366F1,#8B5CF6);-webkit-background-clip:text;-webkit-text-fill-color:transparent">FORM</span><span style="color:rgba(255,255,255,.6)">ate</span></div>
...
function updateRep(hipYnorm,idx){
  ...
  if(repState==="IDLE"){
    ...
    if(hipYnorm>peakY){peakY=hipYnorm;repState="AT_BOTTOM";}
      ...
      el.style.color="#fff";setTimeout(()=>el.style.color="#60A5FA",250);
      repState="IDLE";
    }
  }
}
